...
# photo         <-- emulated by using saved image on the RPi
#
# ACTUATORS:
#
...
class DeviceConnector:
	...
	def photo(self):
                ...
                # EMULATED - since no real camera is used these lines are only an example
                #
                # self.camera.capture('/home/pi/Pictures/image1.jpeg')
                # self.camera.close()

                # print "photo provided"
